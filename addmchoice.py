...
with transaction.atomic():
    ...
    zvinizlomi = MchoiceTask.objects.create(name="Zvini in zlomi - imobilizacija", max_points=3, category="nnz")
    ...
    MchoiceAnswer.objects.create(vpr=vpr1, ans="Ne premikaj ga, saj ima mogoče poškodovano hrbtenico.", prav=False)
    ...
    MchoiceAnswer.objects.create(vpr=vpr2, ans="Komolec hladiš in ga poviješ tako, da ga ne more premikati.", prav=False)
    ...
    MchoiceAnswer.objects.create(vpr=vpr3, ans="Gleženj si je zvil. Nanj naj si da obkladek in ga povije tako, da se ne bo premikal. Izogiba naj se hoji.", odg="", prav=False)
